...
const Logo = memo(function Logo({ size = 'md', showText = true, variant = 'default' }) {
  ...
  return (
    <div className="flex items-center gap-3">
      {/* Logo Icon */}
      <div className={`${sizeConfig.container} ${variantClass} rounded-2xl shadow-lg flex items-center justify-center relative overflow-hidden group`}>
        {/* Animated background */}
      ...
      {showText && (
        <div className="flex flex-col">
          <h1 className={`${sizeConfig.text} font-bold bg-gradient-to-r from-primary via-purple-600 to-pink-600 bg-clip-text text-transparent`}>
            Space4U
          </h1>
